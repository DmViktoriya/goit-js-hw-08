...
let sizeDiv = 30;
function callback() {
    +input.value <= +input.getAttribute('max') && +input.value >= 1 ? createBoxes(+input.value) : alert('введите число от 1 до 100')
    ...
    boxContainer.innerHTML = ''; input.value = 0; sizeDiv = 30;
}
